...
enum Operator{CPY, INC, DEC, JNZ};

const char REGISTER_START_VALUE = 0;
const char COPY_STR[4] = "cpy";
const char INCREMENT_STR[4] = "inc";
const char DECREMENT_STR[4] = "dec";
const char JUMP_STR[4] = "jnz";
const int NULL_REG_ID = CHAR_MAX;
const char ID_HASH = 'a';
const int AFTER_COMMAND_LOCATION = 4;
const int BASE = 10;
const char PATH[70] = "C:\\Users\\ossis\\ClionProjects\\joulukalenteri_2016\\12\\input.txt";
